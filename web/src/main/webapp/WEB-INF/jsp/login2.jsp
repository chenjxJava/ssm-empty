...
<meta charset="UTF-8">
<title></title>
<script Language="JavaScript" src="${ctxStatic }/js/user/login2.js"></script>
</head>
<body style="background-color: #FFFFFF;">
	<div style="width: 100%; height: 100%;">
		...
		<div style="width: 1024px; height: 400px; margin: auto;">
			...
			<div
				style="width: 1024px; height: 40px; margin-top: 10px; color: #8f8f8f; font-size: 18px; text-align: center; line-height: 40px;">你正在使用手机登入,请输入注册手机号码！</div>
