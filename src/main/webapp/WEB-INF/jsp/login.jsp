...
<form method="post" action="${ctx }/login/login.html" onsubmit="return check();">
<div class="container" style=" height:470px; background-color:#A3c2f2;">
	<div class="container_div">
          ...
          <div style=" width:350px; height:320px; margin-top:42px; background-color:#ffffff; opacity:80%; border-radius:4px; float:right;">
            ...
            <input class="land_inp" id="email" value="${user}" name="username" type="text" placeholder="请输入您的账号" />
            <input class="land_inp1" id="password1"  name="password1" type="password" placeholder="请输入您的密码" />
            <input class="land_inp1" id="password" name="password" type="hidden"/>
            <div class="land_inp2" id ="ts">${errMsg}</div>
            <button class="land_btn"  type="submit" id="submit_btn1">&nbsp;登&nbsp;录&nbsp </button>
             <div style="float:left; margin-left: 20px; margin-top:5px;font-size:14px;"><a style="text-decoration:none;" href="${ctx }/center/toRegister.html">立即注册</a></div>
